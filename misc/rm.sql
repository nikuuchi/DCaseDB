...
ALTER TABLE node_link_has_snapshot       AUTO_INCREMENT = 1;
...
ALTER TABLE process_context_has_snapshot AUTO_INCREMENT = 1;
ALTER TABLE snapshot                     AUTO_INCREMENT = 1;
ALTER TABLE snapshot_has_node_data       AUTO_INCREMENT = 1;
